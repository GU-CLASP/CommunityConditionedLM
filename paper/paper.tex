...
two which were primarily non-English and two with particularly\jp{quantify?} short average message lengths.
...
The vocabulary consisted of the most frequent tokens at the message level,
meaning that we only counted each token once per message.
