...
TODO: !!! we should take the correlation of a random 16 × 510 with the web embeddings !!!


Thus if \(d(L,S)\) is below \(μ-3σ\), we can safely assume that there % below, because we have a distance rather than correlation in this convention.
