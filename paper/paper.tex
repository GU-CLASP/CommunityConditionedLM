...
Some of the most linguistically complex communities benifit a lot
from community conditioning, while others do not benefit at all. 
Similarly, among the less linguistically complex communites 
...
per-word ranging from less than 53 to more than 104 for the best model \bn{update}
architecture.
...
$l_c=1$ being the best.  For transformer models, it varies between \bn{update}
