...
The vocabulary is drawn from the set of all words appearing with a frequency
greater than \num{5e-5} (1 in \num{2000}) in at least one community.
This results in a vocabulary size of \num{47403}, including a special
out-of-vocablary token.
