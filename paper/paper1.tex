...
To get a handle on the relationship between the linguistic and social embeddigs
...
\[C = \{(x = L_i · L_j, y = S_i · S_j) \text {~for~} i,j ∈ [1,512]\}\] % BN: changed \C to C. Definition for \C may be missing 
